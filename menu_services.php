...
<div class="container-fluid p-0 banner-services">
    <img src="img/banner_service.jpg" class="w-100" alt="">
  </div>

<section class="mt-5 mx-5">
    <div class="tittle_destop">
        <h2 class="text-desktop fw-bold">Semua Repair Service</h2>
    </div>